...
class PortariaResourceIT {
    ...
    private static final String DEFAULT_JUSTIFICATIVA_EXCLUSAO = "AAAAAAAAAA";
    private static final String UPDATED_JUSTIFICATIVA_EXCLUSAO = "BBBBBBBBBB";
    ...
    public static Portaria createEntity(EntityManager em) {
        Portaria portaria = new Portaria()
            ...
            .ano(DEFAULT_ANO)
            .justificativaExclusao(DEFAULT_JUSTIFICATIVA_EXCLUSAO)
    ...
    public static Portaria createUpdatedEntity(EntityManager em) {
        Portaria portaria = new Portaria()
            ...
            .ano(UPDATED_ANO)
            .justificativaExclusao(UPDATED_JUSTIFICATIVA_EXCLUSAO)
    ...
    void getAllPortarias() throws Exception {
        ...
        restPortariaMockMvc
            ...
            .andExpect(jsonPath("$.[*].justificativaExclusao").value(hasItem(DEFAULT_JUSTIFICATIVA_EXCLUSAO)))
    ...
    void getPortaria() throws Exception {
        ...
        restPortariaMockMvc
            ...
            .andExpect(jsonPath("$.justificativaExclusao").value(DEFAULT_JUSTIFICATIVA_EXCLUSAO))
    ...
    void partialUpdatePortariaWithPatch() throws Exception {
        ...
        partialUpdatedPortaria.numero(UPDATED_NUMERO).dataFim(UPDATED_DATA_FIM);
