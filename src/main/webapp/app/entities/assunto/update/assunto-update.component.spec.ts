...
describe('Assunto Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Topico query and add missing value', () => {
      ...
      const topicos: ITopico[] = [{ id: 'b1365cc1-0c0e-40a1-abad-27a24c7a3d29' }];
      assunto.topicos = topicos;

      const topicoCollection: ITopico[] = [{ id: '4dacefe4-fdd5-45cf-b976-9d24a7ab49c4' }];
    ...
    it('Should update editForm', () => {
      const assunto: IAssunto = { id: 456 };
      const topicos: ITopico = { id: 'e6b5d87d-3ddb-45b0-b256-861dfc297e97' };
      assunto.topicos = [topicos];
