...
type PortariaFormGroupContent = {
  ...
  dataInicio: FormControl<PortariaFormRawValue['dataInicio']>;
  dataFim: FormControl<PortariaFormRawValue['dataFim']>;
  ano: FormControl<PortariaFormRawValue['ano']>;
  justificativaExclusao: FormControl<PortariaFormRawValue['justificativaExclusao']>;
...
export class PortariaFormService {
  createPortariaFormGroup(portaria: PortariaFormGroupInput = { id: null }): PortariaFormGroup {
    ...
    return new FormGroup<PortariaFormGroupContent>({
      ...
      dataInicio: new FormControl(portariaRawValue.dataInicio),
      dataFim: new FormControl(portariaRawValue.dataFim),
      ano: new FormControl(portariaRawValue.ano),
      justificativaExclusao: new FormControl(portariaRawValue.justificativaExclusao),
