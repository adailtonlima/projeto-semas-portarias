...
describe('Portaria Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Assunto query and add missing value', () => {
      ...
      const assunto: IAssunto = { id: 32373 };
      portaria.assunto = assunto;

      const assuntoCollection: IAssunto[] = [{ id: 11415 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const portaria: IPortaria = { id: 456 };
      const setor: ISetor = { id: 7158 };
      portaria.setor = setor;

      const setorCollection: ISetor[] = [{ id: 13155 }];
    ...
    it('Should call Usuario query and add missing value', () => {
      const portaria: IPortaria = { id: 456 };
      const usuario: IUsuario = { id: 3853 };
      portaria.usuario = usuario;
      const updatedBy: IUsuario = { id: 341 };
      portaria.updatedBy = updatedBy;
      const deletedBy: IUsuario = { id: 55 };
      portaria.deletedBy = deletedBy;

      const usuarioCollection: IUsuario[] = [{ id: 5876 }];
    ...
    it('Should update editForm', () => {
      const portaria: IPortaria = { id: 456 };
      const assunto: IAssunto = { id: 31892 };
      portaria.assunto = assunto;
      const setor: ISetor = { id: 7375 };
      portaria.setor = setor;
      const usuario: IUsuario = { id: 2733 };
      portaria.usuario = usuario;
      const updatedBy: IUsuario = { id: 13574 };
      portaria.updatedBy = updatedBy;
      const deletedBy: IUsuario = { id: 14856 };
      portaria.deletedBy = deletedBy;
