...
describe('Usuario Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Perfil query and add missing value', () => {
      ...
      const perfil: IPerfil = { id: 20318 };
      usuario.perfil = perfil;

      const perfilCollection: IPerfil[] = [{ id: 12954 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const usuario: IUsuario = { id: 456 };
      const setor: ISetor = { id: 24128 };
      usuario.setor = setor;

      const setorCollection: ISetor[] = [{ id: 19740 }];
    ...
    it('Should update editForm', () => {
      const usuario: IUsuario = { id: 456 };
      const perfil: IPerfil = { id: 25720 };
      usuario.perfil = perfil;
      const setor: ISetor = { id: 30751 };
      usuario.setor = setor;
