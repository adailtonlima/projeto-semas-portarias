        ...
        Optional<Topico> result = topicoRepository
            ...
            .map(existingTopico -> {
                ...
                if (topico.getConteudo() != null) {
                    existingTopico.setConteudo(topico.getConteudo());
                }
                if (topico.getAtivo() != null) {
                    existingTopico.setAtivo(topico.getAtivo());
                }
                if (topico.getCreatedAt() != null) {
                    existingTopico.setCreatedAt(topico.getCreatedAt());
                }
                if (topico.getUpdatedAt() != null) {
                    existingTopico.setUpdatedAt(topico.getUpdatedAt());
                }
                if (topico.getDeletedAt() != null) {
                    existingTopico.setDeletedAt(topico.getDeletedAt());
                }
