...
public class Portaria implements Serializable {
    ...
    @Column(name = "justificativa_exclusao")
    ...
    public Portaria dataInicio(LocalDate dataInicio) {
    ...
    public Portaria dataFim(LocalDate dataFim) {
    ...
    public Portaria ano(Integer ano) {
        this.setAno(ano);
        return this;
    }
    ...
    public Portaria justificativaExclusao(String justificativaExclusao) {
        this.setJustificativaExclusao(justificativaExclusao);
        return this;
    }
    ...
    public String toString() {
        return "Portaria{" +
            ...
            ", dataFim='" + getDataFim() + "'" +
            ", ano=" + getAno() +
            ", justificativaExclusao='" + getJustificativaExclusao() + "'" +
