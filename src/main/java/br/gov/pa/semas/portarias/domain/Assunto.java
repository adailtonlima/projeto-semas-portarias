...
public class Assunto implements Serializable {
    ...
    public void setTopicos(Set<Topico> topicos) {
        if (this.topicos != null) {
            this.topicos.forEach(i -> i.removeAssuntos(this));
        }
        if (topicos != null) {
            topicos.forEach(i -> i.addAssuntos(this));
        }
    ...
    public Assunto addTopicos(Topico topico) {
        this.topicos.add(topico);
        topico.getAssuntos().add(this);
        return this;
    }

    public Assunto removeTopicos(Topico topico) {
