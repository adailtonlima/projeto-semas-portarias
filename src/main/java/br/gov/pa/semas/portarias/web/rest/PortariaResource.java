    ...
    public ResponseEntity<Portaria> partialUpdatePortaria(
        ...
        Optional<Portaria> result = portariaRepository
            ...
            .map(existingPortaria -> {
                ...
                if (portaria.getDataInicio() != null) {
                    existingPortaria.setDataInicio(portaria.getDataInicio());
                }
                if (portaria.getDataFim() != null) {
                    existingPortaria.setDataFim(portaria.getDataFim());
                }
                if (portaria.getAno() != null) {
                    existingPortaria.setAno(portaria.getAno());
                }
                if (portaria.getJustificativaExclusao() != null) {
                    existingPortaria.setJustificativaExclusao(portaria.getJustificativaExclusao());
                }
