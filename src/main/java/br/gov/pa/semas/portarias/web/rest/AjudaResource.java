        ...
        Optional<Ajuda> result = ajudaRepository
            ...
            .map(existingAjuda -> {
                ...
                if (ajuda.getConteudo() != null) {
                    existingAjuda.setConteudo(ajuda.getConteudo());
                }
                if (ajuda.getAtivo() != null) {
                    existingAjuda.setAtivo(ajuda.getAtivo());
                }
                if (ajuda.getCreatedAt() != null) {
                    existingAjuda.setCreatedAt(ajuda.getCreatedAt());
                }
                if (ajuda.getUpdatedAt() != null) {
                    existingAjuda.setUpdatedAt(ajuda.getUpdatedAt());
                }
                if (ajuda.getDeletedAt() != null) {
                    existingAjuda.setDeletedAt(ajuda.getDeletedAt());
                }
